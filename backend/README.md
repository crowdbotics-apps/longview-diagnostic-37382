...
## Project Structure
    ...
    ├── longview_diagnostic_37382  # Django project configurations
...
1. Clone this repo and `cd longview_diagnostic_37382`
...
2. Clone this repo and `cd longview_diagnostic_37382`
